            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading bg-info"><h3 class="panel-title ">Add Product</h3></div>
                        <br>
                                ...
                                @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="email" name="product_code" placeholder="Product Code">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="product_garage" id="experience" placeholder="Godaun Number">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="product_route" id="salary" placeholder="Product Route">
                                        </div>
                                ...
                                @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="buy_date" id="vacation" placeholder="Buying Date">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="expire_date" id="City" placeholder="Expire Date">
                                        </div>
                                ...
                                @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nid_no" name="buying_price" placeholder="Buying Price">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="selling_price" id="City" placeholder="Selling Price">
                                        </div>
