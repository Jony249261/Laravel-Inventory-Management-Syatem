                ...
                <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading bg-info">
                                        ...
                                        <span class="pay-salary">{{date("F Y")}}</span>
                                            <a href="{{route('advanced.salary')}}" class="btn btn-success pull-right"><i class="fas fa-plus-square"></i> Pay Now</a>
                                        </h3>
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            {{--<td>{{ $advanced->advanced_salary }}</td>--}}
